...
def get_token_auth_header():
    ...
    # If auth header is not set in request, return error
    ...
    # Return the token value from the the header
...
def check_permissions(permission, payload):
    ...
    if permission not in payload['permissions']:
        raise AuthError({
            ...
            'description': 'Operation not allowed. Check your permissions.'
        }, 401)
        ...
        try:
            ...
            raise AuthError({
                ...
                'description': 'incorrect claims,'
                                'please check the audience adn issuer'
            }, 401)
        except Exception:
            raise AuthError({
                'code': 'invalid_header',
